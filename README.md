...
# -> {"short_code": "0000001", "short_url": "http://127.0.0.1:8000/0000001", ...}
...
Prints throughput (req/sec) and p50/p95/p99 latency, measured against your
own setup rather than quoted from elsewhere.
